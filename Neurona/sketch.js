...
function setup() {
  ...
  var BotonControl = createButton("Control");
  BotonControl.class("BotonEntrenar");

  var BotonBotella = createButton("Botella");
  BotonBotella.class("BotonEntrenar");

  var BotonESP32 = createButton("");
